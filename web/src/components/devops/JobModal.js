            ...
            <Form form={form} {...formItemLayout}
                ...
                <Form.Item label="任务类型" name='func' rules={[{required: true, message: '请选择任务类型'}]}>
                    <Select onChange={(value) => {
                        ...
                        <Select.Option value="ldap-task-process-job">LDAP同步</Select.Option>
                        <Select.Option value="apply-sensitive-job">敏感规则扫描</Select.Option>
                        {/* <Select.Option value="check-asset-status-job">资产状态检测</Select.Option> */}
                        <Select.Option value="check-task-process-status-job">任务状态检测</Select.Option>
                        <Select.Option value="update-device-status-job">更新设备状态</Select.Option>
                    </Select>
                </Form.Item>
