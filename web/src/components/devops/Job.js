...
const Job = () => {
    ...
    const columns = [
        ...
        , {
            ...
            render: (func, record) => {
                switch (func) {
                    case "ldap-task-process-job":
                        return <Tag color="green">LDAP同步</Tag>;
                    case "update-device-status-job":
                        return <Tag color="green">更新设备状态</Tag>;
                    case "apply-sensitive-job":
                    case "check-task-process-status-job":
                        return <Tag color="green">任务状态检测</Tag>;
