...
import MyAlarmLog from "./worker/MyAlarmLog";
    ...
    return (
        <>
            <Content className={'page-container-white'}>
                <Tabs className={'info-tab'} tabPosition={isMini ? 'top' : 'left'} tabBarStyle={{ ...(isMini ? {} : { width: 150 }), }}>
                    <Tabs.TabPane tab="通知中心" key="alarm-log">
                        <MyAlarmLog />
                    </Tabs.TabPane>
                    <Tabs.TabPane tab="文件空间" key="file-space">
                        <FileSpace />
                    </Tabs.TabPane>
