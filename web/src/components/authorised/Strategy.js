...
const Strategy = () => {
    ...
    },
    {
        ...
        render: (text, record, _, action) => [
            ...
            ,
            <Show menu={'strategy-detail'} key={'strategy-get'}>
                <Link key="get" to={`/strategy/${record['id']}?activeKey=bind-user`}>绑定用户</Link>
            </Show>,
