...
class FileShare extends Component {
    ...
    state = {
        storage: {},
        currentPathFileCallback: undefined,
    }

    componentDidMount() {
        this.getDefaultStorage();
        this.setState({
            currentPathFileCallback: this.props.currentPathFileCallback,
        })
    }
    ...
    currentPathCallback = (currentPath) => {
        // console.log(" currentPath ",currentPath)   
        this.state.currentPathFileCallback(currentPath) 
        // this.setState({
            ...
            <div>
                <Content key='page-container' className={[contentClassName]}>
                    ...
                    <FileSystemSpace storageId={getCurrentUser()['id']}
                        ...
                        currentPathCallback={this.currentPathCallback}
