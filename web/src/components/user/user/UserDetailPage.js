...
import UserStrategyPolicy from "./UserStrategyPolicy";
    ...
    return (
        <div className="page-detail-warp">
            <Tabs activeKey={activeKey} onChange={handleTagChange}>
                ...
                {
                    hasMenu('user-strategy-policy') &&
                    <Tabs.TabPane tab="空间策略" key="strategy-policy">
                        <UserStrategyPolicy active={activeKey === 'strategy-policy'} userId={id} />
                    </Tabs.TabPane>
                }
            </Tabs>
        </div>
