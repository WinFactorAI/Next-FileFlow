...
import { Button, ConfigProvider, Layout, Modal, Popconfirm, Select, Table, Tag } from "antd";
import React, { useState } from 'react';
import alarmLogApi from "../../api/alarm-log";
    ...
    const columns = [
        ...
        }, 
        {
            ...
            render: (text, record, _, action) => [
                <Show menu={'alarm-log-del'} key={'alarm-log-del'}>
                    <Popconfirm
                        key={'confirm-delete'}
                        title='确认'
                        onConfirm={async () => {
